...
###################################################
mh <- bv_metropolis(scale_hess = c(0.05, 0.0001, 0.0001), adjust_acc = TRUE,
...
###################################################
run <- bvar(x, lags = 5, n_draw = 10000, n_burn = 5000, n_thin = 1,
...
run_app <- bvar(y, lags = 5, n_draw = 25000, n_burn = 15000,
