...
% Hardcoded due to progress bar - care for proper values
\begin{Soutput}
...
% Hardcoded to match outputs above
\begin{Soutput}
...
\begin{figure}[!ht]
	\centering
  \includegraphics[height=14cm]{img/fig-trace_density.png}
...
\begin{figure}[!ht]
	\centering
  \includegraphics[width=0.9\textwidth]{img/fig-betas.pdf}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.9\textwidth]{img/fig-irf_cholesky.pdf}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.9\textwidth]{img/fig-predict_unconditional.pdf}
...
<<app_timeseries, fig=TRUE, eval=TRUE, echo=FALSE, include=FALSE, width=8, height=3>>=
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.9\textwidth]{img/fig-app_timeseries.pdf}
...
\begin{figure}[ht]
	\centering
  \includegraphics[width=0.9\linewidth]{img/fig-app_chains.png}
...
\begin{figure}[ht!]
	\centering
  \includegraphics[width=0.9\linewidth]{img/fig-app_irf_signs.pdf}
...
\begin{figure}[ht]
	\centering
  \includegraphics[width=0.9\textwidth]{img/fig-app_predict_conditional.pdf}
