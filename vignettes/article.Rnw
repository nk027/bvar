...
The NIW family includes many of the most commonly used priors \citep{koop2010, karlsson2013}, with some notable exceptions. These include, amongst others, the steady-state prior \citep{villani2009}, the Normal-Gamma prior \citep{brown2010, huber2019}, and the Dirichlet-Laplace prior \citep{bhattacharya2015}.
