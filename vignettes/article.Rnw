...
The NIW family includes some of the most commonly used priors \citep{koop2010, karlsson2013}, with notable exceptions. These include the steady-state prior \citep{villani2009}, the Normal-Gamma prior \citep{griffin2010, huber2019}, and the Dirichlet-Laplace prior \citep{bhattacharya2015}.
